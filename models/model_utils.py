...
def load_model(model_class, model_path, load_as_dataparralel=False):
    """Load previously trained models."""

    if load_as_dataparralel:
...
def save_model(model, model_name, save_as_dataparallel=True):
    """Save trained models."""
    if save_as_dataparallel:
...
class Residual(nn.Module):
    ...
    def forward(self, x, *args, **kwargs):
        return self.fn(x, *args, **
                       kwargs) + x  # this is the residual connection
...
class SinusoidalPositionEmbeddings(nn.Module):
    ...
    def __init__(self, dim):
        super().__init__()
        self.dim = dim  # you define the dimension of the positional embeddings
